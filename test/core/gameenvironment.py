...
class GameEnvironmentTest(unittest.TestCase):
    ...
    def test_pass(self):
        ...
        actual = self.environment.get_round_reward()
        self.assertCountEqual([10, -10, False], actual)
    ...
    def test_end_of_game(self):
        ...
        actual = self.environment.get_round_reward()
        self.assertCountEqual([10, -10, True], actual)

        self.environment.current_round = 3
        self.player1.rounds_won = 2

        actual = self.environment.get_game_reward()
        self.assertCountEqual([100, -100], actual)
